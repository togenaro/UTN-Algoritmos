...
// -----------------------------------------
int ingresarOrden(int, float);
void ingresarSubIndices(int*, int*, int);
void mostrarSubIndices(int*, /* int*, */ int);
void mostrarVectorOriginal(int*, int);

// ************ METODOS **************
void metodoBurbuja(int*, int);
void metodoInsercion(int*, int);
void metodoSeleccion(int*, int);
void metodoQuicksort(int*, int, int);
void metodoMergesort(int*, int, int);
// ***********************************
...
main()
{
	...
	// --------------------------
	N = ingresarOrden(N, Nfloat);
	
	int vector[N] = {0}; // Declaración e inicializacion del vector original
	int vectorCopia[N] = {0}; // Copia del vector original ingresado.
	// --------------------------
...
int ingresarOrden(int f01_N, float f01_Nfloat)
{
